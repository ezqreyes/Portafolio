...
<template>
    <section id="home"
        class="lg:h-[85vh] flex items-center bg-light-primary dark:bg-dark-primary py-8 lg:py-0 overflow-hidden">
        ...
        :visible="{
           ...
           <div class="flex flex-col md:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <!-- <p class="text-lg text-black dark:text-white text-md mb-[22px]"> Hey, I'm Ezequiel Reyes! </p> -->
                <h1 class="text-4xl leading-[44px] md:text-5xl md:leading-tight lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px]">
                    Hey, I'm Ezequiel
                </h1>
                <h2 class="text-3xl leading-[44px] pb-8 md:text-4xl md:leading-tight lg:text-6xl lg:leading-[1.2] font-bold md:tracking-[-2px]">
                    PHP  Developer 
                </h2>
                <!-- <p class="pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left">
                    Analyst and programmer of systems with high capacity of learning and adaptation, responsible and committed.
                </p> -->
                <button class="btn btn-md bg-blue-600 text-white hover:bg-blue-800 dark:bg-blue-800 dark:hover:bg-blue-600 rounded-md md:btn-lg transition-all">
                    About me
                </button>
                <div class="pt-12">
            <h5
            ...
            <div class="flex items-center mb-6">
              ...
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://www.linkedin.com/in/ezqreyes"
              >
                <svg
                  width="14"
                  height="14"
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
              <img class="opacity-70 h-[540px]" src="/LaravelProjects/portafolio/public/img/job.png" alt="Hero">
            </div>
           </div>
        </div>
    </section>
