            ...
            <div class="max-w-md mx-auto sm:px-6 lg:px-8 bg-white">
                <form class="p-4" @submit.prevent="submit">
                    <div>
                        ...
                        <InputError class="mt-2" :message="$page.props.skill_id" />
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        <TextInput id="project_url" type="text" class="mt-1 block w-full" v-model="$page.props.project_url"
...
const submit = () => {
    Inertia.post(`/LaravelProjects/portafolio/public/projects/${props.project.id}`, {
    _method: "put",
    name: form.name,
    image: form.image,
